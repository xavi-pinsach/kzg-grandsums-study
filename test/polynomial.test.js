...
function radomPolynomial(minDegree, maxDegree, curve) {
    const degree = getRandomValue(minDegree, maxDegree);
...
describe("Polynomial tests", function () {
    ...
    it("should check if two polynomials are equal", async () => {
        ...
        const pol1 = radomPolynomial(10, 30, curve);
    ...
    it("should get the correct coefficient", async () => {
        const polynomial = radomPolynomial(10, 30, curve);
    ...
    it("should get the correct length", async () => {
        const length = getRandomValue(10, 30);
    ...
    it("should add a polynomial", async () => {
        const polynomial1 = radomPolynomial(10, 30, curve);
        const polynomial2 = radomPolynomial(10, 30, curve);
    ...
    it("should multiply by a polynomial", async () => {
        const Fr = curve.Fr;

        // Polynomial 1: 2x^3 - 3x^2 + 2
        // Polynomial 2: x^2 + 3x
        // Reusltant:    2x^5 + 3x^4 - 9x^3 + 2x^2 + 6x
        const pol1 = Polynomial.fromCoefficientsArray([Fr.e(2), Fr.e(0), Fr.e(-3), Fr.e(2)], curve);
    ...
    it("should truncate a polynomial", async () => {
        const random1 = getRandomValue(10, 20);
        const random2 = getRandomValue(10, 30);
